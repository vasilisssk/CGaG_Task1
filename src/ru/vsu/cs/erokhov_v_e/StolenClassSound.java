...
public class StolenClassSound implements AutoCloseable {
    ...
    public StolenClassSound(File f) {
        try {
	...
	*/
    ...
    public static StolenClassSound playSound(String path) {
        File f = new File(path);
        StolenClassSound snd = new StolenClassSound(f);
        snd.play();
        return snd;
    }
